...
const int16_t TIMEZONE = 1;       // 1 für MEZ
const uint8_t DAY_SAVE_TIME = 1;  // 1 bei Sommerzeit, 0 sonst
...
void setup() {
  ...
  if (initWiFi()) {
    Serial.println("Ok!");
    Serial.println("Hole Internet-Zeit");
    initTime();  // Zeit per ntp holen
    Serial.println("Ok!");
  } else {
    Serial.println("Kein WLAN, keine Echtzeit!");
  }
}
